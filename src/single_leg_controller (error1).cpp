...
SingleLegController::SingleLegController() : nh_("~") {
    ...
    // 制御パラメータの読み込み
    nh_.param<uint32_t>("control/position_limit/max", control_params_.position_max, 4095);
    nh_.param<uint32_t>("control/position_limit/min", control_params_.position_min, 0);
    nh_.param<uint32_t>("control/velocity_limit", control_params_.velocity_limit, 1023);
